...
public class CheckedTextViewCustom extends CheckedTextView {
    ...
    public CheckedTextViewCustom(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setTypeface(WalltyApplication.dinRoundProRegular);
    }

    public CheckedTextViewCustom(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
